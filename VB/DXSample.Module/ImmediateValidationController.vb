		...
		Private Sub ValidateViewObjects()
			If View IsNot Nothing Then
				If TypeOf View Is ListView Then
					If Frame.IsViewControllersActivation Then
				...
				Else
					...
					ValidateObjects(objectsSelector.GetObjectsToValidate((CType(View.ObjectSpace, ObjectSpace)).Session, View.CurrentObject))
				End If
			End If
		End Sub
